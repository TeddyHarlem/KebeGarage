					...
					<div className="row">
						<div className="col-lg-6">
							<div className="sec-title style-two">
								<h2>Why Choose Us</h2>
								<div className="text">
									Discover why Kebe Garage is your ultimate choice for
									automotive care. With a commitment to excellence and a
									dedication to customer satisfaction, we offer a range of
									premium services designed to keep your vehicle running
									smoothly.
								</div>
							</div>
